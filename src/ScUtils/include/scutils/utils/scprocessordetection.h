...
#ifndef SCPROCESSORDETECTION_H
#define SCPROCESSORDETECTION_H

/*
	This file uses preprocessor #defines to set various SC_PROCESSOR_* #defines
	based on the following patterns:

	SC_PROCESSOR_{FAMILY}
	SC_PROCESSOR_{FAMILY}_{VARIANT}
	SC_PROCESSOR_{FAMILY}_{REVISION}
	...
	SC_BYTE_ORDER appropriately for the target processor. For bi-endian
...
#  define SC_BIG_ENDIAN __ORDER_BIG_ENDIAN__
#else
#  define SC_BIG_ENDIAN 4321
#endif
#if defined(__ORDER_LITTLE_ENDIAN__)
#  define SC_LITTLE_ENDIAN __ORDER_LITTLE_ENDIAN__
#else
#  define SC_LITTLE_ENDIAN 1234
#endif
...
// #  define SC_PROCESSOR_ALPHA
// SC_BYTE_ORDER not defined, use endianness auto-detection
...
#    define SC_PROCESSOR_ARM_64
#    define SC_PROCESSOR_WORDSIZE 8
#  else
#    define SC_PROCESSOR_ARM_32
#  endif
#  if defined(__ARM_ARCH) && __ARM_ARCH > 1
#    define SC_PROCESSOR_ARM __ARM_ARCH
#  elif defined(__TARGET_ARCH_ARM) && __TARGET_ARCH_ARM > 1
#    define SC_PROCESSOR_ARM __TARGET_ARCH_ARM
#  elif defined(_M_ARM) && _M_ARM > 1
#    define SC_PROCESSOR_ARM _M_ARM
#  elif defined(__ARM64_ARCH_8__) \
      || defined(__aarch64__) \
      || defined(__ARMv8__) \
      || defined(__ARMv8_A__) \
      || defined(_M_ARM64)
#    define SC_PROCESSOR_ARM 8
...
#    define SC_PROCESSOR_ARM 6
#  elif defined(__ARM_ARCH_5TEJ__) \
        || defined(__ARM_ARCH_5TE__)
#    define SC_PROCESSOR_ARM 5
#  else
#    define SC_PROCESSOR_ARM 0
#  endif
#  if SC_PROCESSOR_ARM >= 8
#    define SC_PROCESSOR_ARM_V8
#  endif
#  if SC_PROCESSOR_ARM >= 7
#    define SC_PROCESSOR_ARM_V7
#  endif
#  if SC_PROCESSOR_ARM >= 6
#    define SC_PROCESSOR_ARM_V6
#  endif
#  if SC_PROCESSOR_ARM >= 5
#    define SC_PROCESSOR_ARM_V5
#  else
#    error "ARM architecture too old"
#  endif
#  if defined(__ARMEL__) || defined(_M_ARM64)
#    define SC_BYTE_ORDER SC_LITTLE_ENDIAN
#  elif defined(__ARMEB__)
#    define SC_BYTE_ORDER SC_BIG_ENDIAN
#  else
// SC_BYTE_ORDER not defined, use endianness auto-detection
#endif
...
#  define SC_PROCESSOR_X86_32
#  define SC_BYTE_ORDER SC_LITTLE_ENDIAN
#  define SC_PROCESSOR_WORDSIZE   4

/*
 * We define SC_PROCESSOR_X86 == 6 for anything above a equivalent or better
...
#  define SC_PROCESSOR_POWER
#  if defined(__ppc64__) || defined(__powerpc64__) || defined(__64BIT__)
#    define SC_PROCESSOR_POWER_64
#    define SC_PROCESSOR_WORDSIZE 8
#  else
#    define SC_PROCESSOR_POWER_32
#  endif
// SC_BYTE_ORDER not defined, use endianness auto-detection
...
#  define SC_PROCESSOR_RISCV
#  if __riscv_xlen == 64
#    define SC_PROCESSOR_RISCV_64
#  else
#    define SC_PROCESSOR_RISCV_32
#  endif
#  define SC_BYTE_ORDER SC_LITTLE_ENDIAN
...
#  define SC_PROCESSOR_S390
#  if defined(__s390x__)
#    define SC_PROCESSOR_S390_X
#  endif
#  define SC_BYTE_ORDER SC_BIG_ENDIAN
...
*/
// #elif defined(__sh__)
// #  define SC_PROCESSOR_SH
// #  if defined(__sh4a__)
// #    define SC_PROCESSOR_SH_4A
// #  endif
// SC_BYTE_ORDER not defined, use endianness auto-detection
...
#  define SC_PROCESSOR_SPARC
#  if defined(__sparc_v9__)
#    define SC_PROCESSOR_SPARC_V9
#  endif
#  if defined(__sparc64__)
#    define SC_PROCESSOR_SPARC_64
#  endif
#  define SC_BYTE_ORDER SC_BIG_ENDIAN

// -- Web Assembly --
#elif defined(__EMSCRIPTEN__)
#  define SC_PROCESSOR_WASM
#  define SC_BYTE_ORDER SC_LITTLE_ENDIAN
#  define SC_PROCESSOR_WORDSIZE 8
#endif
...
#if !defined(SC_BYTE_ORDER)
#  if defined(__BYTE_ORDER__) && (__BYTE_ORDER__ == SC_BIG_ENDIAN || __BYTE_ORDER__ == SC_LITTLE_ENDIAN)
// Reuse __BYTE_ORDER__ as-is, since our SC_*_ENDIAN #defines match the preprocessor defaults
#    define SC_BYTE_ORDER __BYTE_ORDER__
...
/*
   ...
   * If SC_PROCESSOR_WORDSIZE was defined above, it's assumed to match the pointer
	 size.
   Otherwise, we assume to be 32-bit and then check in qglobal.cpp that it is right.
*/

#if defined __SIZEOF_POINTER__
#  define SC_POINTER_SIZE           __SIZEOF_POINTER__
#elif defined(__LP64__) || defined(_LP64)
#  define SC_POINTER_SIZE           8
#elif defined(SC_PROCESSOR_WORDSIZE)
#  define SC_POINTER_SIZE           SC_PROCESSOR_WORDSIZE
#else
#  define SC_POINTER_SIZE           4
#endif

/*
   Define SC_PROCESSOR_WORDSIZE to be the size of the machine's word (usually,
   ...
   Falls back to SC_POINTER_SIZE if not set explicitly for the platform.
*/
#ifndef SC_PROCESSOR_WORDSIZE
#  define SC_PROCESSOR_WORDSIZE        SC_POINTER_SIZE
#endif


#endif // SCPROCESSORDETECTION_H
